...
key_data_t key_map[N_COLS*N_ROWS*N_FN_LAYERS] =
{
  ...
  {MODIFIER_NONE, KEY_SW_QUOTE}, {MODIFIER_NONE, KEY_SW_COMMA}, {MODIFIER_NONE, KEY_SW_PUNCT}, {MODIFIER_NONE, KEY_SW_P}, {MODIFIER_NONE, KEY_SW_Y}, {MODIFIER_LCTRL, 0},
    {MODIFIER_NONE, KEY_SW_F}, {MODIFIER_NONE, KEY_SW_G}, {MODIFIER_NONE, KEY_SW_C}, {MODIFIER_NONE, KEY_SW_R}, {MODIFIER_NONE, KEY_SW_L}, {MODIFIER_LGUI, 0}, //leftmost thumb
  {MODIFIER_NONE, KEY_SW_A}, {MODIFIER_NONE, KEY_SW_O}, {MODIFIER_NONE, KEY_SW_E}, {MODIFIER_NONE, KEY_SW_U}, {MODIFIER_NONE, KEY_SW_I}, {MODIFIER_NONE, KEY_SW_SPACE},
    {MODIFIER_NONE, KEY_SW_D}, {MODIFIER_NONE, KEY_SW_H}, {MODIFIER_NONE, KEY_SW_T}, {MODIFIER_NONE, KEY_SW_N}, {MODIFIER_NONE, KEY_SW_S}, {MODIFIER_NONE, KEY_LAYER2},
  {MODIFIER_LSHIFT, KEY_SW_COMMA}, {MODIFIER_NONE, KEY_SW_Q}, {MODIFIER_NONE, KEY_SW_J}, {MODIFIER_NONE, KEY_SW_K}, {MODIFIER_NONE, KEY_SW_X}, {MODIFIER_NONE, KEY_LAYER1},
    {MODIFIER_NONE, KEY_SW_B}, {MODIFIER_NONE, KEY_SW_M}, {MODIFIER_NONE, KEY_SW_W}, {MODIFIER_NONE, KEY_SW_V}, {MODIFIER_NONE, KEY_SW_Z}, {MODIFIER_NONE, KEY_LAYER3}, //rightmost thumb
  ...
  {MODIFIER_NONE, KEY_SW_BACKSPACE}, {MODIFIER_NONE, KEY_SW_4}, {MODIFIER_NONE, KEY_SW_5}, {MODIFIER_NONE, KEY_SW_6}, {MODIFIER_NONE, KEY_SW_ENTER}, {MODIFIER_NONE, KEY_SW_SPACE}, 
    {MODIFIER_NONE, KEY_SW_DELETE}, {MODIFIER_LSHIFT, KEY_SW_8}, {MODIFIER_LSHIFT, KEY_SW_9}, {MODIFIER_NONE, KEY_SW_AE}, {MODIFIER_NONE, KEY_SW_OE}, {MODIFIER_NONE, KEY_LAYER3},
  {MODIFIER_NONE, KEY_SW_TAB}, {MODIFIER_NONE, KEY_SW_1}, {MODIFIER_NONE, KEY_SW_2}, {MODIFIER_NONE, KEY_SW_3}, {MODIFIER_NONE, KEY_SW_0}, {MODIFIER_NONE, KEY_LAYER1},
    {MODIFIER_ALTGR, KEY_SW_PLUS}, {MODIFIER_ALTGR, KEY_SW_8}, {MODIFIER_ALTGR, KEY_SW_9}, {MODIFIER_LSHIFT, KEY_SW_1}, {MODIFIER_ALTGR, KEY_SW_LESST}, {MODIFIER_NONE, KEY_LAYER2},
  ...
  {MODIFIER_NONE, KEY_SW_F1}, {MODIFIER_NONE, KEY_SW_F2}, {MODIFIER_NONE, KEY_SW_F3}, {MODIFIER_NONE, KEY_SW_F4}, {MODIFIER_NONE, KEY_SW_F5}, {MODIFIER_LCTRL, 0}, 
   ...
   {MODIFIER_NONE, KEY_SW_PLUS}, {MODIFIER_NONE, KEY_SW_HYPH}, {MODIFIER_LSHIFT, KEY_SW_0}, {MODIFIER_LSHIFT, KEY_SW_QUOTE},{MODIFIER_NONE, KEY_SW_F6}, {MODIFIER_NONE, 0}, 
  ...
  {MODIFIER_LSHIFT, KEY_SW_TAB}, {MODIFIER_LSHIFT, KEY_SW_HYPH}, {MODIFIER_LSHIFT, KEY_SW_6}, {MODIFIER_LSHIFT, KEY_SW_3}, {MODIFIER_LSHIFT, KEY_SW_5}, {MODIFIER_NONE, 0},
    {MODIFIER_NONE, 0}, {MODIFIER_NONE, 0}, {MODIFIER_NONE, 0}, {MODIFIER_NONE, KEY_SW_FTICK}, {MODIFIER_NONE, 0}, {MODIFIER_NONE, 0},
  ...
  {MODIFIER_LSHIFT, KEY_SW_PUNCT}, {MODIFIER_LSHIFT, KEY_SW_Q}, {MODIFIER_LSHIFT, KEY_SW_J}, {MODIFIER_LSHIFT, KEY_SW_K}, {MODIFIER_LSHIFT, KEY_SW_X}, {MODIFIER_NONE, KEY_SW_BACKSPACE},
    {MODIFIER_LSHIFT, KEY_SW_B}, {MODIFIER_LSHIFT, KEY_SW_M}, {MODIFIER_LSHIFT, KEY_SW_W}, {MODIFIER_LSHIFT, KEY_SW_V}, {MODIFIER_LSHIFT, KEY_SW_Z}, {MODIFIER_NONE, KEY_LAYER2},
  {MODIFIER_NONE, 0}, {MODIFIER_NONE, KEY_SW_LEFT}, {MODIFIER_NONE, KEY_SW_UP}, {MODIFIER_NONE, KEY_SW_RIGHT}, {MODIFIER_NONE, 0}, {MODIFIER_NONE, KEY_SW_DOWN}, 
    {MODIFIER_NONE, 0}, {MODIFIER_LALT, 0}, {MODIFIER_NONE, KEY_SW_PGUP}, {MODIFIER_NONE, KEY_SW_END}, {MODIFIER_NONE, 0}, {MODIFIER_NONE, KEY_SW_PGDOWN}
};
