...
key_data_t key_map[N_COLS*N_ROWS*N_FN_LAYERS] =
{
  ...
  {MODIFIER_ALTGR, KEY_SW_DDOT}, {MODIFIER_NONE, KEY_SW_7}, {MODIFIER_NONE, KEY_SW_8},{MODIFIER_NONE, KEY_SW_9}, {MODIFIER_LSHIFT, KEY_SW_7}, {MODIFIER_LCTRL, 0}, 
    {MODIFIER_NONE, KEY_SW_ESC}, {MODIFIER_ALTGR, KEY_SW_7} ,{MODIFIER_ALTGR, KEY_SW_0}, {MODIFIER_ALTGR, KEY_SW_4}, {MODIFIER_NONE, KEY_SW_AO}, {MODIFIER_NONE, 0},
  ...
  {MODIFIER_NONE, KEY_SW_BACKSPACE}, {MODIFIER_NONE, KEY_SW_1}, {MODIFIER_NONE, KEY_SW_2}, {MODIFIER_NONE, KEY_SW_3}, {MODIFIER_NONE, KEY_SW_0}, {MODIFIER_NONE, KEY_LAYER1},
  ...
  //level 2
  {MODIFIER_NONE, KEY_SW_F2}, {MODIFIER_NONE, KEY_SW_F3}, {MODIFIER_NONE, KEY_SW_F4}, {MODIFIER_NONE, KEY_SW_F5}, {MODIFIER_NONE, KEY_SW_F6}, {MODIFIER_LCTRL, 0}, 
    {MODIFIER_NONE, KEY_SW_F7}, {MODIFIER_NONE, KEY_SW_F8}, {MODIFIER_NONE, KEY_SW_F9}, {MODIFIER_NONE, KEY_SW_F10}, {MODIFIER_NONE, KEY_SW_F11}, {MODIFIER_NONE, 0},
   {MODIFIER_NONE, KEY_SW_PLUS}, {MODIFIER_NONE, KEY_SW_HYPH}, {MODIFIER_LSHIFT, KEY_SW_0}, {MODIFIER_LSHIFT, KEY_SW_QUOTE},{MODIFIER_NONE, KEY_SW_F1}, {MODIFIER_NONE, 0}, 
    {MODIFIER_NONE, KEY_SW_F12}, {MODIFIER_ALTGR, KEY_SW_2}, {MODIFIER_LSHIFT, KEY_SW_PLUS}, {MODIFIER_NONE, KEY_SW_ACCENT}, {MODIFIER_LSHIFT, KEY_SW_DDOT}, {MODIFIER_LGUI, 0},
  {MODIFIER_NONE, MODIFIER_NONE}, {MODIFIER_NONE, MODIFIER_NONE}, {MODIFIER_NONE, MODIFIER_NONE}, {MODIFIER_NONE, 0}, {MODIFIER_NONE, 0}, {MODIFIER_NONE, 0},
    {MODIFIER_NONE, 0}, {MODIFIER_LALT, 0}, {MODIFIER_NONE, 0}, {MODIFIER_NONE, 0}, {MODIFIER_NONE, 0}, {MODIFIER_NONE, KEY_LAYER2},
  ...
  {MODIFIER_LSHIFT, KEY_SW_2}, {MODIFIER_NONE, KEY_SW_LESST}, {MODIFIER_LSHIFT, KEY_SW_LESST}, {MODIFIER_LSHIFT, KEY_SW_P}, {MODIFIER_LSHIFT, KEY_SW_Y}, {MODIFIER_LSHIFT, KEY_SW_ENTER},
    {MODIFIER_LSHIFT, KEY_SW_F}, {MODIFIER_LSHIFT, KEY_SW_G}, {MODIFIER_LSHIFT, KEY_SW_C}, {MODIFIER_LSHIFT, KEY_SW_R}, {MODIFIER_LSHIFT, KEY_SW_L}, {MODIFIER_NONE, KEY_LAYER3},
  {MODIFIER_LSHIFT, KEY_SW_A}, {MODIFIER_LSHIFT, KEY_SW_O}, {MODIFIER_LSHIFT, KEY_SW_E}, {MODIFIER_LSHIFT, KEY_SW_U}, {MODIFIER_LSHIFT, KEY_SW_I}, {MODIFIER_NONE, KEY_SW_SPACE},
    {MODIFIER_LSHIFT, KEY_SW_D}, {MODIFIER_LSHIFT, KEY_SW_H}, {MODIFIER_LSHIFT, KEY_SW_T}, {MODIFIER_LSHIFT, KEY_SW_N}, {MODIFIER_LSHIFT, KEY_SW_S}, {MODIFIER_NONE, 0},
